...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=6C63FF&center=true&vCenter=true&width=700&lines=Full-Stack+Java+Developer+%F0%9F%9A%80;Ex-Microsoft+Technical+Intern+%F0%9F%92%BC;AI+%26+ML+Enthusiast+%F0%9F%A4%96;Spring+Boot+%7C+React.js+%7C+Python+Developer;Building+AI-powered+Applications+%E2%9A%A1;Azure+AI+%7C+Agentic+AI+Explorer+%E2%98%81%EF%B8%8F)](https://readme-typing-svg.herokuapp.com)

---

## 👩‍💻 About Me

Hi! I'm **Harshini GB**, a passionate **Full-Stack Developer** and **AI enthusiast** from Bengaluru, India. I recently completed my B.E. in Computer Science & Engineering at RR Institute of Technology with a CGPA of **9.0/10**.

I had the privilege of working as a **Technical Intern at Microsoft Corporation India** (Feb–April 2026), where I built AI-driven learning modules for the Skill India Digital Hub using Agentic AI, Azure AI services, and Microsoft Foundry tools.

I love building end-to-end applications — from clean REST APIs with Spring Boot to responsive UIs with React.js — and I'm always exploring the intersection of AI and software development.

| 🔭 | Currently building AI-powered full-stack applications |
|---|---|
| 🎓 | B.E. Computer Science & Engineering — CGPA 9.0/10 (2022–2026) |
| 💼 | Ex-Technical Intern @ Microsoft Corporation India |
| 🌱 | Exploring Agentic AI, Azure AI, and Generative AI |
| 🏆 | 3rd Place — National Level Hackathon |
| 📍 | Bengaluru, India |
| 📧 | harshinigb34@gmail.com |
| ☎️ | (+91) 9353257142 |
...
| 🏢 | **Microsoft Corporation India Pvt Ltd — Technical Intern** &nbsp; *Feb 2026 – April 2026 \| Bengaluru, India* |
|---|---|
| | Developed and published **5+ AI-focused learning modules** for the Skill India Digital Hub using Articulate 360, contributing to scalable digital skilling initiatives. Translated complex AI concepts into clear, interactive learner-centric modules. Gained hands-on exposure to **Agentic AI, Microsoft Foundry tools, and Azure AI services**. |
| 💻 | **Study Comrade — Frontend Developer Intern (Project-Based)** &nbsp; *July 2024 – August 2024* |
| | Developed a **Job Search Platform** using React.js with responsive design and structured UI components. Built multiple frontend applications with interactive UI features improving performance, usability, and interface consistency. |
...
![Trophies](https://github-profile-trophy.vercel.app/?username=Harshinigb&theme=tokyonight&no-frame=true&no-bg=true&margin-w=4&column=7)

---

## 📈 Contribution Graph

![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=Harshinigb&theme=tokyo-night&hide_border=true&bg_color=0D1117&color=6C63FF&line=6C63FF&point=FF6B6B)
